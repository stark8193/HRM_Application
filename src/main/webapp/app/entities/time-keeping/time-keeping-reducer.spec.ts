...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_TIMEKEEPING_LIST actions', async () => {
    ...
    it('dispatches FETCH_TIMEKEEPING actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_TIMEKEEPING actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_TIMEKEEPING actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_TIMEKEEPING actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_TIMEKEEPING actions', async () => {
      const expectedActions = [
        {
