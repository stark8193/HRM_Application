...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_LEAVETYPE_LIST actions', async () => {
    ...
    it('dispatches FETCH_LEAVETYPE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_LEAVETYPE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_LEAVETYPE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_LEAVETYPE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_LEAVETYPE actions', async () => {
      const expectedActions = [
        {
