...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_LEAVEREQUEST_LIST actions', async () => {
    ...
    it('dispatches FETCH_LEAVEREQUEST actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_LEAVEREQUEST actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_LEAVEREQUEST actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_LEAVEREQUEST actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_LEAVEREQUEST actions', async () => {
      const expectedActions = [
        {
